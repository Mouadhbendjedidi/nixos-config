{ pkgs, ... }:
{
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      set -g @pomodoro_sound '/home/mouadh/.local/bin/tmux-bell'
      ...
      set -ogq @thm_bg "#1d2428"
      set -ogq @thm_surface_0 "#2d393d"
      set -ogq @thm_surface_1 "#3d494d"
      set -ogq @thm_surface_2 "#4a585c"
      set -ogq @thm_overlay_0 "#58686d"
      set -ogq @thm_overlay_1 "#6f8788"
      set -ogq @thm_overlay_2 "#839e9a"
      set -ogq @thm_subtext_0 "#96b4aa"
      set -ogq @thm_subtext_1 "#adc9bc"
